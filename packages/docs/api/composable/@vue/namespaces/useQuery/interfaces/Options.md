[@vue/apollo-composable](../../../../index.md) / [useQuery](../index.md) / Options
...
> `optional` **enabled**: [`MaybeRefOrGetter`](https://vuejs.org/api/utility-types.html#maybereforgetter)\<`boolean` \| `undefined`\>
