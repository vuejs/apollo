...
export interface DollarApollo<V> {
  ...
  addSmartQuery<R=any>(key: string, options: VueApolloQueryOptions<V, R>): SmartQuery;
  addSmartSubscription<R=any>(key: string, options: VueApolloSubscriptionOptions<V, R>): SmartSubscription;
}
