...
> [!IMPORTANT]
> You are browsing the code for the next version (v5) of Vue Apollo. The current stable version is v4 available [here](https://github.com/vuejs/apollo/tree/v4).
...
<p align="center">
  <a href="https://itcare.net" target="_blank">
    <img src='./packages/docs/public/sponsors/it-care.svg' width="400px" />
    <br>ITcare
  </a>
</p>
